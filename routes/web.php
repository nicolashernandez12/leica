...
Route::get('/tipoinventario', 'TipoInventarioController@index')->name('tipoinventario');

Route::get('/procesoinventario', 'ProcesoInventarioController@index')->name('procesoinventario');
